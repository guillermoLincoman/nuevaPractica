...
/** \brief Imprime una Editorial sin cabecera, Complementaria de funcion controller_ListEditoriales
 *
 * \param Employee* this = puntero a editorial que se va a mostrar
 *
 */
...
void editorial_printEditorial(eEditorial* thisEditorial)
{
	...
	{
		editorial_getIdEditorial(thisEditorial, &idEditorial);
